...
SOURCE_PATH="/home/evangelos/Desktop/HadoopAssignment/numeronym/Numeronym.java"

# Hadoop User's workspace
WORKSPACE="$HOME/bda"

# Class and Package info
PACKAGE_NAME="numeronym"
MAIN_CLASS="${PACKAGE_NAME}.Numeronym"
...
if [ ! -f "$WORKSPACE/Numeronym.java" ]; then
...
javac -d . Numeronym.java

echo "[4/6] Creating JAR..."
# Package the directory matching the package name (numeronym)
